...
function newTask() {
  ...
  const newTodo = { detail: userInput, completed: false };
  tasks.push(newTodo);
...
function completeTask(taskElement) {
  ...
  // console.log(tasks);
    ...
    const taskText = taskElement.querySelector('p').innerText.trim(); // Trim removes whitespace
  ...
  if (taskIndex !== -1) {
    ...
    taskElement.querySelector('p').classList.toggle("strike");
  } else {
    console.warn("Task not found:", taskText);
  }
